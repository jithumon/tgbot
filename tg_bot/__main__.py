...
Maintained by [Him](t.me/lolboyisback)
"""
...
It took lots of work for [my creator](t.me/lolboyisback) to get me to work
But now no need to donate just Chill out!!"""
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Contact Me in Pm..")
