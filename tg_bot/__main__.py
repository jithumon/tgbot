...
There are two ways of paying him; [PayPal](starkindusttri), or [Monzo](@starkinusttri)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖  Admin ", url="https://t.me/starkindusttri")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/mwcinema2"), InlineKeyboardButton(text="🔔 text", url="https://t.me/starkindusttri'")],
                     [InlineKeyboardButton(text="🎬 Youtube Channel", url="https://t.me/mwcinema2"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
