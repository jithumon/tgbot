        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="GROUP", url="https://t.me/joinchat/AAAAAEkPrah1asIHMBiURA".format(bot.username)),  InlineKeyboardButton(text="CHANNEL", url="https://t.me/joinchat/UbomgFXMHwiHf2SN")],) ]]))
